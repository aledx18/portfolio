    ...
    <main>
      <section className='flex flex-col items-center md:h-screen md:justify-center mt-28'>
        <div className='md:my-0 flex flex-col justify-center text-center lg:text-left lg:flex-row md:justify-between md:items-center mt-10'>
          <div className='md:flex-1 md:mr-20 mt-5 lg:mt-0'>
            ...
            <p className='text-lg font-Hind lg:text-lg mb-7'>
              ...
              exceed user expectations. My expertise in technologies such as
              JavaScript, Typescript, React, and Next.js has enabled me to
              develop dynamic and responsive websites that deliver exceptional
              user experiences.
            </p>
        ...
        <svg viewBox='0 0 800 800' width={300} height={300}>
          <g
            ...
            strokeLinecap='round'
            strokeLinejoin='round'
            transform='matrix(0.39073112848927394,0.9205048534524403,-0.9205048534524403,0.39073112848927394,679.9094899852665,-124.49439277668569)'>
            <path
              d='M250 250Q493 322 400 400Q277 472 550 550 '
              markerEnd='url(#SvgjsMarker1232)'
            />
          </g>
          <defs>
            <marker
      ...
      <section>
        <div className='flex gap-10 items-center md:my-0 justify-center md:flex-row flex-col my-20'>
          ...
          <div id='second-section' className='flex gap-4 md:gap-6'>
            {tech.java}
